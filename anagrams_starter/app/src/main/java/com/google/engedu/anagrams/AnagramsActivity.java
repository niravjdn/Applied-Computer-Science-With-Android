...
public class AnagramsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(this, "Dictionary has been loaded", Toast.LENGTH_LONG).show();
        } catch (IOException e) {
    ...
    private void processWord(EditText editText) {
        ...
        Toast.makeText(this, "size "+anagrams.size() + " word " +anagrams.get(2), Toast.LENGTH_LONG).show();
